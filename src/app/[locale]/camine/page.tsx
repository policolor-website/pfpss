...
export default function CamineDirectorPage() {
  const t = useTranslations("camine");
  ...
  const filtered = useMemo(() => {
    ...
    if (judetFilter) {
      result = result.filter((c) => c.judet === judetFilter);
    }
        ...
        <section className="relative overflow-hidden bg-gold/20 pt-20 pb-16">
          ...
          <div className="max-w-7xl mx-auto px-6 relative">
            ...
            >
              ...
              <span className="text-navy-deep/70">{t("breadcrumb.current")}</span>
            </motion.nav>
            ...
            >
              {t("hero.description", { total: stats.total })}
            </motion.p>
