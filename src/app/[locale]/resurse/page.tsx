...
const publicDocuments = [
  {
    titleKey: "publicDocs.0.title",
    descKey: "publicDocs.0.description",
    href: "/documents/scrisoare-deschisa-ministerul-muncii-2026-07-23.pdf",
  },
];

const exploreIcons = [Gavel, BookOpen, ShieldCheck];
