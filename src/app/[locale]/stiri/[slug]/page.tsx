...
const articles: Record<string, Article> = {
  "scrisoare-deschisa-ministerul-muncii-iulie-2026": {
    ...
    pdfLabel: "Descarcă scrisoarea integrală (PDF)",
    pdfSubLabel: "Nr. înreg. 61/23.07.2026",
    paragraphs: [
...
export default function ArticlePage({
  ...
  const t = useTranslations("stiriDetail");
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-heading text-base font-semibold text-navy-deep">
                      {article.pdfLabel || t("downloadPdf")}
                    </h3>
