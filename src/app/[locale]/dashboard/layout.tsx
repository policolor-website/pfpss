...
const navItemsConfig = [
  ...
  { href: "/dashboard/cotizatie", labelKey: "nav.fee", icon: CreditCard },
  { href: "/dashboard/documente", labelKey: "nav.documents", icon: FileText },
  { href: "/dashboard/petitii", labelKey: "nav.petitions", icon: PenSquare },
];
      ...
      <aside className="hidden lg:flex w-64 flex-col bg-navy-deep text-paper fixed inset-y-0 left-0 z-40">
        <div className="p-6 border-b border-white/10">
          <Link href={prefix || "/"} className="flex items-center gap-2">
            ...
            <span className="text-xs text-paper/40">{t("portal")}</span>
          </Link>
        </div>
